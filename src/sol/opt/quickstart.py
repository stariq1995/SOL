...
__all__ = ['from_app', 'from_app_weighted']
...
def from_app_weighted(topo, app, network_config, epoch_weights):
    """
    Create an optimization from a single application.
    ...
    # Weight of 1 means no other apps, use full objective value as is.
    print("changed to avg")
    opt.compose_objectives(array([epoch_objs]), EpochComposition.WEIGHTED, Fairness.WEIGHTED, array([1]), epoch_weights)
    return opt
